                ...
                ? TextButton(
                    ...
                    child: Text(
                      ...
                      style: positiveTextStyle ??
                          TextStyle(
                              color: Theme.of(context).primaryColor, fontSize: Theme.of(context).textTheme.labelLarge!.fontSize),
                    ),
                  )
                : Container(),
          ],
          ...
          [
            ...
            TextButton(
              ...
              child: Text(
                ...
                style:
                    TextStyle(color: Theme.of(context).primaryColor, fontSize: Theme.of(context).textTheme.labelLarge!.fontSize),
              ),
            ),
          ],
      elevation: 0.0,
